...
class SimCalendar extends XCalendar {
  ...
  Future<List<OpenBlock>> getFreeBlocks (DateTime startAt, DateTime endAt) async {
    ...
    startAt = DateTime(startAt.year,startAt.month,startAt.day,XConfiguration.workdayStart.hour);
    endAt = DateTime(endAt.year,endAt.month,endAt.day,XConfiguration.workdayEnd.hour);  
