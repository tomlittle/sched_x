...
class GoogleCalendar extends XCalendar {
  ...
  Future<List<OpenBlock>> getFreeBlocks (DateTime startAt, DateTime endAt) async {
    ...
    startAt = DateTime(startAt.year,startAt.month,startAt.day,XConfiguration.workdayStart.hour,XConfiguration.workdayStart.minute);
    endAt = DateTime(endAt.year,endAt.month,endAt.day,XConfiguration.workdayEnd.hour,XConfiguration.workdayEnd.minute);  
    int _nDays = (endAt.difference(startAt)).inDays+1;
    int _dailyDuration = ((XConfiguration.workdayEnd.hour-XConfiguration.workdayStart.hour)*60+
                         (XConfiguration.workdayEnd.minute-XConfiguration.workdayStart.minute)) * ONE_MINUTE;
